...
namespace CompleteWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private string Location { get; set; } = "Pau";
        ...
        private async void GetBackground()
        {
            ...
            var result = await ApiCaller.Get(url, "563492ad6f91700001000001f070e081ce76465cab3ff763466cce18");
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=d93ee6498a95a71453be83be31598058&units=metric";
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=d93ee6498a95a71453be83be31598058&units=metric";
            var result = await ApiCaller.Get(url);
